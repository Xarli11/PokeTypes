...
### Changed
- **UI Refinement:** Split the main H1 into a brand name and a hidden SEO suffix (`sr-only`) to maintain clean aesthetics while preserving search engine visibility.
- **i18n:** Refined translation keys for better modularity in the header section.
...
### Added
- "Buy Me a Coffee" button in the contact section.

## [2.24.2] - 2026-02-25

### Fixed
- Prevent theme flicker (flashbang) on initial load by applying the dark theme earlier in the lifecycle.
